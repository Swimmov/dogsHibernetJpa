...
public class MainHiberJpaClassDog {
    ...
    public static void main(String[] args) throws IOException {
        HiberJpaPlayers player1 = new HiberJpaPlayers();
        HiberJpaPlayers player2 = new HiberJpaPlayers();
        HiberJpaCpuPlayer cpuPlayer = new HiberJpaCpuPlayer();
        HiberJpaFoodForDogs dogFood = new HiberJpaFoodForDogs();
        HiberJpaDogsBreed dogBreed = new HiberJpaDogsBreed();
...
//-------------------------------------------  TWO PLAYERS ------------------------------------------------//
        if (numberOfPlayers == 2) {
            ...
            // choose the size of the dog for player1
            System.out.println("\n\t Ok, " + player1.getName() + ", please, choose the size of your dog:");
            System.out.println("\t1. Large size, \n\t2. Medium size, \n\t3. Small size");
            System.out.println("---||-----------------------------------------------------||");
// exceptionForm for playerDogSize (String)
...
// delay before Enter pressed (throwing)
    ...
    public static String printAndSetTheBreed(String size, HiberJpaDogsBreed breed) throws IOException {
...
//exceptionForm for DogForWater
    ...
    public static void printChosenParameters(int numOfPlayers, HiberJpaFoodForDogs ffd, HiberJpaPlayers p1, HiberJpaPlayers p2) {
    ...
    public static void myThread () throws IOException {
        ...
        HiberJpaMyThread myThread = new HiberJpaMyThread();
        BufferedReader bufferedReader = new BufferedReader(new InputStreamReader(System.in));
        myThread.start();
    ...
    static void compareFloat(float player1Result, float player2Result, HiberJpaPlayers pl1Name, HiberJpaPlayers pl2Name){
